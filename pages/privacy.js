    ...
    <Container>
      <Col>
        ...
        <div className={styles.mainSection}>
          <p>
            Andrew Marshall built the Dog Destinations app as an Ad Supported
            app. This SERVICE is provided by Andrew Marshall at no cost and is
            ...
            is accessible at Dog Destinations unless otherwise defined in this
            Privacy Policy.
          </p>
          ...
          <ul>
            ...
            <li>
              <a href='https://www.facebook.com/about/privacy/update/printabl'>
                Facebook
              </a>
            </li>
            <li>
          ...
          <p>
            ...
            third parties have access to your Personal Information. The reason
          ...
          <p>
            ...
            page. This policy is effective as of 2020-09-29
          </p>
          <div className={styles.subHeading}>
            <h3>Contact Us</h3>
          </div>
          ...
          <p>
            ...
            do not hesitate to contact us at contact@dogdestinations.co.uk.
          </p>
          <div className={styles.subHeading}>
            <h3>Andrew Marshall</h3>
          </div>
